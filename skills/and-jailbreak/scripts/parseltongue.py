...
Usage:
    ...
    # As a module in execute_code (location-agnostic — works from the AND
    # repo or any Hermes install; the loader resolves the scripts dir)
    #   from load_godmode import *   # or exec() the loader
